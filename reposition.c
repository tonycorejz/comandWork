 ...
 * По второму клику в той же точке, проверяем, ставим вертикальный
 * По третьему клику в той же точке, удаляем корабль
 * По клику в другой точке, переходим на следующий корабль
 * */
